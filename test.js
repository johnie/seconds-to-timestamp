...
test('Format and validate "1 second and 25 milliseconds"', (t) => {
  t.is(secondsToTimestamp(1.25), '00:00:01.25');
});
...
test('Format and validate "10 seconds and 05 milliseconds"', (t) => {
  t.is(secondsToTimestamp(10.05), '00:00:10.05');
});
...
test('Format and validate "4321.5 seconds as 1 hour 12 minutes and 1 second and 50 milliseconds"', (t) => {
  t.is(secondsToTimestamp(4321.5), '01:12:01.50');
});
